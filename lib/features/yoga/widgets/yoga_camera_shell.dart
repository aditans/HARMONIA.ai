...
class YogaCameraShell extends StatefulWidget {
  const YogaCameraShell({
    super.key,
  ...
  @override
  State<YogaCameraShell> createState() => _YogaCameraShellState();
}

class _YogaCameraShellState extends State<YogaCameraShell> {
  ...
  @override
  void didUpdateWidget(covariant YogaCameraShell oldWidget) {
  ...
  Future<void> _initializeCamera() async {
    try {
      ...
      if (!mounted) return;
      setState(() {
        errorMessage = 'Camera permission is required to run Yoga Mode.';
      });
    }
  }
