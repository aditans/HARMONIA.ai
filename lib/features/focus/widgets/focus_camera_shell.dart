...
class FocusCameraShell extends StatefulWidget {
  const FocusCameraShell({
    super.key,
  ...
  @override
  State<FocusCameraShell> createState() => _FocusCameraShellState();
}

class _FocusCameraShellState extends State<FocusCameraShell> {
  ...
  @override
  void didUpdateWidget(covariant FocusCameraShell oldWidget) {
  ...
  Future<void> _initializeCamera() async {
    try {
      ...
      if (!mounted) return;
      setState(() {
        errorMessage = 'Camera permission is required to run Study Focus Mode.';
      });
    }
  }
